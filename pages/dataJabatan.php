...
if (isset($_SESSION['user'])) {
  //Panggil header
    ...
    $getJabatan = $mysqli->query("SELECT * FROM tbl_jabatan order by id asc");
?>
    <!-- ----------------------------------- Start Body ------------------------------------ -->
             ...
             if(isset($_GET["error"])) { ?>
              <div class="alert alert-danger alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                Gagal input data jabatan!
              </div>
              <?php 
              }else if(isset($_GET["sukses"])) { ?>
                  <div class="alert alert-success alert-dismissible" role="alert">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                Sukses input data jabatan!
                  </div>
              <?php
              }
              ?> 
              <table id="example1" class="table table-bordered table-striped">
                ...
                echo '<tr>';
                  ...
                  echo '<td><a href="../setting/pHapusJabatan.php?id='.$row['id'].'" type="button" class="btn btn-xs bg-maroon" data-toggle="tooltip" title="Hapus"> <i class="fa fa-trash"></i></a></td>';
                echo '</tr>';
                $r++;
                  }
                ?>
