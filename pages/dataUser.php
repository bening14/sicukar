...
if (isset($_SESSION['user'])) {
  //Panggil header
    ...
    $getUser = $mysqli->query("SELECT * FROM mst_user order by id asc");
?>
    <!-- ----------------------------------- Start Body ------------------------------------ -->
            ...
            <?php
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                echo '<tr>';
                  ...
                  echo '<td><a href="../setting/pHapusUser.php?id='.$row['id'].'" type="button" class="btn btn-xs bg-maroon" data-toggle="tooltip" title="Hapus"> <i class="fa fa-trash"></i></a></td>';
                echo '</tr>';
                $r++;
                  }
                ?>
