              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ...
                    <small>CV. Solusi Cipta Media</small>
                  </p>
                </li>
                <!-- Menu Body -->
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="../pages/karyawan.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
          <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="../pages/dataCutiKaryawan.php"><i class="fa fa-circle-o"></i> Data Cuti</a></li>
